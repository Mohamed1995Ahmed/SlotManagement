...
export const SUPPORTED_TIME_ZONES: string[] = [
  ...
  'Africa/Bissau', 'Africa/Blantyre', 'Africa/Brazzaville', 'Africa/Bujumbura', 'Africa/Casablanca', 'Africa/Ceuta', 'Africa/Conakry',
  ...
  'America/Resolute', 'America/Rio_Branco', 'America/Santa_Isabel', 'America/Santarem',
